...
data:extend({
  ...
  },
  {
    ...
    category        = "armor-forging",
    ingredients = {
      {type = "item", name = "pentapod-tissue-samples", amount = 5},
...
data:extend({{
  ...
  results = {
    {type = "item", name = "stone",      amount = 25,  ignored_by_productivity = 25},
    {type = "item", name = "iron-ore",   amount = 1,   ignored_by_productivity = 1},
    {type = "item", name = "copper-ore", amount = 1,   ignored_by_productivity = 1},
    {type = "item", name = "ice",        amount = 100, ignored_by_productivity = 100},
  },
  allow_productivity = true,
}})

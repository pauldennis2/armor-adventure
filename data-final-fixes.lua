-- Prevent Castra Prime's Forge from re-categorizing any armor-adventure recipe.
-- The category == "armor-forging" check misses recipes in the default crafting category,
-- so we flag every recipe we own by name.
do
  local our_recipes = {
  ...
  if mods["Moshine"] then
    table.insert(our_recipes, "personal-tesla-turret")
    table.insert(our_recipes, "unstable-magnetized-data-core")
    table.insert(our_recipes, "deosil-motion-data")
    table.insert(our_recipes, "widdershins-motion-data")
    table.insert(our_recipes, "vortex-data-card")
  end
  if mods["panglia_planet"] then
    table.insert(our_recipes, "personal-time-stopper")
  end
  if mods["panglia_planet"] and mods["Moshine"] then
    table.insert(our_recipes, "panglia-essence-of-speed")
  end
  if mods["castra-prime"] then
    table.insert(our_recipes, "personal-combat-roboport")
    table.insert(our_recipes, "personal-combat-roboport-distractor")
    table.insert(our_recipes, "personal-combat-roboport-destroyer")
    table.insert(our_recipes, "simulac-core")
  end
  if mods["planet-rabbasca"] then
    table.insert(our_recipes, "personal-warp-pylon-equipment")
  end
